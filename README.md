...
![fastqc_adapter_content_plot%C2%A0%E2%80%94%20%D0%BA%D0%BE%D0%BF%D0%B8%D1%8F](https://github.com/user-attachments/assets/b50e5ef5-8d62-423d-85ff-6c169bd98782)
...
### Для последующего анализа, в том числе и бонуса, были написаны коды в [jupyter notebook](https://github.com/ksterenteva/hse24_hw1/blob/main/src/сборка%20генома_биоинфа.ipynb) 
...
**Общая длина контигов** почти не изменилась, но с учетом увеличения количества контигов это может означать, что новые контиги короче по сравнению с предыдущими.
